...
Part of a Cyber Infrastructure model such as depicted in \figref{gif:ci} is an object store oriented API - this should be used for data sharing. Such APIs exist such as Amazon's S3.
